...
$t9903_userlevelpermissions = NULL;

//
// Table class for t9903_userlevelpermissions
//
class ct9903_userlevelpermissions extends cTable {
	...
	function __construct() {
		...
		$this->TableVar = 't9903_userlevelpermissions';
		$this->TableName = 't9903_userlevelpermissions';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`t9903_userlevelpermissions`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// userlevelid
		$this->userlevelid = new cField('t9903_userlevelpermissions', 't9903_userlevelpermissions', 'x_userlevelid', 'userlevelid', '`userlevelid`', '`userlevelid`', 3, -1, FALSE, '`userlevelid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// tablename
		$this->_tablename = new cField('t9903_userlevelpermissions', 't9903_userlevelpermissions', 'x__tablename', 'tablename', '`tablename`', '`tablename`', 200, -1, FALSE, '`tablename`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->_tablename->Sortable = TRUE; // Allow sort
		$this->fields['tablename'] = &$this->_tablename;

		// permission
		$this->permission = new cField('t9903_userlevelpermissions', 't9903_userlevelpermissions', 'x_permission', 'permission', '`permission`', '`permission`', 3, -1, FALSE, '`permission`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`t9903_userlevelpermissions`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "t9903_userlevelpermissionslist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("t9903_userlevelpermissionsview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("t9903_userlevelpermissionsview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "t9903_userlevelpermissionsadd.php?" . $this->UrlParm($parm);
		else
			$url = "t9903_userlevelpermissionsadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("t9903_userlevelpermissionsedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("t9903_userlevelpermissionsadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("t9903_userlevelpermissionsdelete.php", $this->UrlParm());
	}
   ...
   // Common render codes
	...
	function WriteAuditTrailDummy($typ) {
		$table = 't9903_userlevelpermissions';
		$usr = CurrentUserID();
