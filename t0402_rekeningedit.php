...
$t0402_rekening_edit = NULL; // Initialize page object first

class ct0402_rekening_edit extends ct0402_rekening {
	...
	// Page object name
	var $PageObjName = 't0402_rekening_edit';
	...
	function Page_Main() {
		...
		if ($this->id->CurrentValue == "") {
			$this->Page_Terminate("t0402_rekeninglist.php"); // Invalid key, return to list
		}
...
// Create page object
if (!isset($t0402_rekening_edit)) $t0402_rekening_edit = new ct0402_rekening_edit();

// Page init
$t0402_rekening_edit->Page_Init();

// Page main
$t0402_rekening_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t0402_rekening_edit->Page_Render();
?>
...
var CurrentForm = ft0402_rekeningedit = new ew_Form("ft0402_rekeningedit", "edit");

// Validate form
ft0402_rekeningedit.Validate = function() {
...
ft0402_rekeningedit.Form_CustomValidate = 
...
ft0402_rekeningedit.ValidateRequired = true;
<?php } else { ?>
ft0402_rekeningedit.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ft0402_rekeningedit.Lists["x_active"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
ft0402_rekeningedit.Lists["x_active"].Options = <?php echo json_encode($t0402_rekening->active->Options()) ?>;
...
<?php if (!$t0402_rekening_edit->IsModal) { ?>
<div class="ewToolbar">
...
<?php } ?>
<?php $t0402_rekening_edit->ShowPageHeader(); ?>
<?php
$t0402_rekening_edit->ShowMessage();
?>
<form name="ft0402_rekeningedit" id="ft0402_rekeningedit" class="<?php echo $t0402_rekening_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t0402_rekening_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t0402_rekening_edit->Token ?>">
<?php } ?>
...
<p class="form-control-static"><?php echo $t0402_rekening->id->EditValue ?></p></span>
</span>
<input type="hidden" data-table="t0402_rekening" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($t0402_rekening->id->CurrentValue) ?>">
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $t0402_rekening_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
ft0402_rekeningedit.Init();
</script>
<?php
$t0402_rekening_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$t0402_rekening_edit->Page_Terminate();
?>
