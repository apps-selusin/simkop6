...
//
// Table class for t0406_labarugi
//
class ct0406_labarugi extends cTable {
	...
	function __construct() {
		...
		$this->TableVar = 't0406_labarugi';
		$this->TableName = 't0406_labarugi';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`t0406_labarugi`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// field01
		$this->field01 = new cField('t0406_labarugi', 't0406_labarugi', 'x_field01', 'field01', '`field01`', '`field01`', 200, -1, FALSE, '`field01`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->field01->Sortable = TRUE; // Allow sort
		$this->fields['field01'] = &$this->field01;

		// field02
		$this->field02 = new cField('t0406_labarugi', 't0406_labarugi', 'x_field02', 'field02', '`field02`', '`field02`', 200, -1, FALSE, '`field02`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->field02->Sortable = TRUE; // Allow sort
		$this->fields['field02'] = &$this->field02;

		// field03
		$this->field03 = new cField('t0406_labarugi', 't0406_labarugi', 'x_field03', 'field03', '`field03`', '`field03`', 200, -1, FALSE, '`field03`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`t0406_labarugi`";
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("t0406_labarugiview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("t0406_labarugiview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "t0406_labarugiadd.php?" . $this->UrlParm($parm);
		else
			$url = "t0406_labarugiadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("t0406_labarugiedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("t0406_labarugiadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("t0406_labarugidelete.php", $this->UrlParm());
	}
