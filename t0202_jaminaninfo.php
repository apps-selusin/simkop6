...
//
// Table class for t0202_jaminan
//
class ct0202_jaminan extends cTable {
	...
	function __construct() {
		...
		$this->TableVar = 't0202_jaminan';
		$this->TableName = 't0202_jaminan';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`t0202_jaminan`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('t0202_jaminan', 't0202_jaminan', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// nasabah_id
		$this->nasabah_id = new cField('t0202_jaminan', 't0202_jaminan', 'x_nasabah_id', 'nasabah_id', '`nasabah_id`', '`nasabah_id`', 3, -1, FALSE, '`nasabah_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// MerkType
		$this->MerkType = new cField('t0202_jaminan', 't0202_jaminan', 'x_MerkType', 'MerkType', '`MerkType`', '`MerkType`', 200, -1, FALSE, '`MerkType`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->MerkType->Sortable = TRUE; // Allow sort
		$this->fields['MerkType'] = &$this->MerkType;

		// NoRangka
		$this->NoRangka = new cField('t0202_jaminan', 't0202_jaminan', 'x_NoRangka', 'NoRangka', '`NoRangka`', '`NoRangka`', 200, -1, FALSE, '`NoRangka`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->NoRangka->Sortable = TRUE; // Allow sort
		$this->fields['NoRangka'] = &$this->NoRangka;

		// NoMesin
		$this->NoMesin = new cField('t0202_jaminan', 't0202_jaminan', 'x_NoMesin', 'NoMesin', '`NoMesin`', '`NoMesin`', 200, -1, FALSE, '`NoMesin`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->NoMesin->Sortable = TRUE; // Allow sort
		$this->fields['NoMesin'] = &$this->NoMesin;

		// Warna
		$this->Warna = new cField('t0202_jaminan', 't0202_jaminan', 'x_Warna', 'Warna', '`Warna`', '`Warna`', 200, -1, FALSE, '`Warna`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Warna->Sortable = TRUE; // Allow sort
		$this->fields['Warna'] = &$this->Warna;

		// NoPol
		$this->NoPol = new cField('t0202_jaminan', 't0202_jaminan', 'x_NoPol', 'NoPol', '`NoPol`', '`NoPol`', 200, -1, FALSE, '`NoPol`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->NoPol->Sortable = TRUE; // Allow sort
		$this->fields['NoPol'] = &$this->NoPol;

		// Keterangan
		$this->Keterangan = new cField('t0202_jaminan', 't0202_jaminan', 'x_Keterangan', 'Keterangan', '`Keterangan`', '`Keterangan`', 201, -1, FALSE, '`Keterangan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->Keterangan->Sortable = TRUE; // Allow sort
		$this->fields['Keterangan'] = &$this->Keterangan;

		// AtasNama
		$this->AtasNama = new cField('t0202_jaminan', 't0202_jaminan', 'x_AtasNama', 'AtasNama', '`AtasNama`', '`AtasNama`', 200, -1, FALSE, '`AtasNama`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`t0202_jaminan`";
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("t0202_jaminanview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("t0202_jaminanview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "t0202_jaminanadd.php?" . $this->UrlParm($parm);
		else
			$url = "t0202_jaminanadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("t0202_jaminanedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("t0202_jaminanadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("t0202_jaminandelete.php", $this->UrlParm());
	}
