...
//
// Table class for t0404_jurnal
//
class ct0404_jurnal extends cTable {
	...
	function __construct() {
		...
		$this->TableVar = 't0404_jurnal';
		$this->TableName = 't0404_jurnal';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`t0404_jurnal`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('t0404_jurnal', 't0404_jurnal', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// Tanggal
		$this->Tanggal = new cField('t0404_jurnal', 't0404_jurnal', 'x_Tanggal', 'Tanggal', '`Tanggal`', ew_CastDateFieldForLike('`Tanggal`', 0, "DB"), 133, 0, FALSE, '`Tanggal`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Tanggal->Sortable = TRUE; // Allow sort
		$this->Tanggal->FldDefaultErrMsg = str_replace("%s", $GLOBALS["EW_DATE_FORMAT"], $Language->Phrase("IncorrectDate"));
		$this->fields['Tanggal'] = &$this->Tanggal;

		// Periode
		$this->Periode = new cField('t0404_jurnal', 't0404_jurnal', 'x_Periode', 'Periode', '`Periode`', '`Periode`', 200, -1, FALSE, '`Periode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Periode->Sortable = TRUE; // Allow sort
		$this->fields['Periode'] = &$this->Periode;

		// NomorTransaksi
		$this->NomorTransaksi = new cField('t0404_jurnal', 't0404_jurnal', 'x_NomorTransaksi', 'NomorTransaksi', '`NomorTransaksi`', '`NomorTransaksi`', 200, -1, FALSE, '`NomorTransaksi`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->NomorTransaksi->Sortable = TRUE; // Allow sort
		$this->fields['NomorTransaksi'] = &$this->NomorTransaksi;

		// Rekening
		$this->Rekening = new cField('t0404_jurnal', 't0404_jurnal', 'x_Rekening', 'Rekening', '`Rekening`', '`Rekening`', 200, -1, FALSE, '`Rekening`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Rekening->Sortable = TRUE; // Allow sort
		$this->fields['Rekening'] = &$this->Rekening;

		// Debet
		$this->Debet = new cField('t0404_jurnal', 't0404_jurnal', 'x_Debet', 'Debet', '`Debet`', '`Debet`', 4, -1, FALSE, '`Debet`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Kredit
		$this->Kredit = new cField('t0404_jurnal', 't0404_jurnal', 'x_Kredit', 'Kredit', '`Kredit`', '`Kredit`', 4, -1, FALSE, '`Kredit`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Keterangan
		$this->Keterangan = new cField('t0404_jurnal', 't0404_jurnal', 'x_Keterangan', 'Keterangan', '`Keterangan`', '`Keterangan`', 200, -1, FALSE, '`Keterangan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`t0404_jurnal`";
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("t0404_jurnalview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("t0404_jurnalview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "t0404_jurnaladd.php?" . $this->UrlParm($parm);
		else
			$url = "t0404_jurnaladd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("t0404_jurnaledit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("t0404_jurnaladd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("t0404_jurnaldelete.php", $this->UrlParm());
	}
