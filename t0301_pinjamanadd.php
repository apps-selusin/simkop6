...
$t0301_pinjaman_add = NULL; // Initialize page object first

class ct0301_pinjaman_add extends ct0301_pinjaman {
	...
	// Page object name
	var $PageObjName = 't0301_pinjaman_add';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "t0301_pinjamanview.php")
...
// Create page object
if (!isset($t0301_pinjaman_add)) $t0301_pinjaman_add = new ct0301_pinjaman_add();

// Page init
$t0301_pinjaman_add->Page_Init();

// Page main
$t0301_pinjaman_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t0301_pinjaman_add->Page_Render();
?>
...
var CurrentForm = ft0301_pinjamanadd = new ew_Form("ft0301_pinjamanadd", "add");

// Validate form
ft0301_pinjamanadd.Validate = function() {
...
ft0301_pinjamanadd.Form_CustomValidate = 
...
ft0301_pinjamanadd.ValidateRequired = true;
<?php } else { ?>
ft0301_pinjamanadd.ValidateRequired = false; 
<?php } ?>
...
<?php if (!$t0301_pinjaman_add->IsModal) { ?>
<div class="ewToolbar">
...
<?php } ?>
<?php $t0301_pinjaman_add->ShowPageHeader(); ?>
<?php
$t0301_pinjaman_add->ShowMessage();
?>
<form name="ft0301_pinjamanadd" id="ft0301_pinjamanadd" class="<?php echo $t0301_pinjaman_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t0301_pinjaman_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t0301_pinjaman_add->Token ?>">
<?php } ?>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $t0301_pinjaman_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
ft0301_pinjamanadd.Init();
</script>
<?php
$t0301_pinjaman_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$t0301_pinjaman_add->Page_Terminate();
?>
