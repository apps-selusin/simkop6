...
//
// Table class for t0303_titipan
//
class ct0303_titipan extends cTable {
	...
	function __construct() {
		...
		$this->TableVar = 't0303_titipan';
		$this->TableName = 't0303_titipan';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`t0303_titipan`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('t0303_titipan', 't0303_titipan', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// pinjaman_id
		$this->pinjaman_id = new cField('t0303_titipan', 't0303_titipan', 'x_pinjaman_id', 'pinjaman_id', '`pinjaman_id`', '`pinjaman_id`', 3, -1, FALSE, '`pinjaman_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Tanggal
		$this->Tanggal = new cField('t0303_titipan', 't0303_titipan', 'x_Tanggal', 'Tanggal', '`Tanggal`', ew_CastDateFieldForLike('`Tanggal`', 0, "DB"), 133, 0, FALSE, '`Tanggal`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Tanggal->Sortable = TRUE; // Allow sort
		$this->Tanggal->FldDefaultErrMsg = str_replace("%s", $GLOBALS["EW_DATE_FORMAT"], $Language->Phrase("IncorrectDate"));
		$this->fields['Tanggal'] = &$this->Tanggal;

		// Keterangan
		$this->Keterangan = new cField('t0303_titipan', 't0303_titipan', 'x_Keterangan', 'Keterangan', '`Keterangan`', '`Keterangan`', 201, -1, FALSE, '`Keterangan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->Keterangan->Sortable = TRUE; // Allow sort
		$this->fields['Keterangan'] = &$this->Keterangan;

		// Masuk
		$this->Masuk = new cField('t0303_titipan', 't0303_titipan', 'x_Masuk', 'Masuk', '`Masuk`', '`Masuk`', 4, -1, FALSE, '`Masuk`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Keluar
		$this->Keluar = new cField('t0303_titipan', 't0303_titipan', 'x_Keluar', 'Keluar', '`Keluar`', '`Keluar`', 4, -1, FALSE, '`Keluar`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Sisa
		$this->Sisa = new cField('t0303_titipan', 't0303_titipan', 'x_Sisa', 'Sisa', '`Sisa`', '`Sisa`', 4, -1, FALSE, '`Sisa`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Sisa->Sortable = TRUE; // Allow sort
		$this->Sisa->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['Sisa'] = &$this->Sisa;

		// Angsuran_Ke
		$this->Angsuran_Ke = new cField('t0303_titipan', 't0303_titipan', 'x_Angsuran_Ke', 'Angsuran_Ke', '`Angsuran_Ke`', '`Angsuran_Ke`', 16, -1, FALSE, '`Angsuran_Ke`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`t0303_titipan`";
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("t0303_titipanview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("t0303_titipanview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "t0303_titipanadd.php?" . $this->UrlParm($parm);
		else
			$url = "t0303_titipanadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("t0303_titipanedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("t0303_titipanadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("t0303_titipandelete.php", $this->UrlParm());
	}
