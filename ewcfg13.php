...
define("EW_PROJECT_NAME", "simkop6_prj", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME, TRUE); // Config file name
define("EW_PROJECT_ID", "{723112A7-6795-416E-B2AF-D90AA7A8CCFB}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'z8Z5gASqamhEfS4u', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/simkop6_prj.css", TRUE); // Project stylesheet file name
...
$EW_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "admin", "db" => "db_simkop6", "qs" => "`", "qe" => "`");
...
define("EW_AUDIT_TRAIL_TABLE_NAME", "t9904_audittrail", TRUE); // Audit trail table name
define("EW_AUDIT_TRAIL_TABLE_VAR", "t9904_audittrail", TRUE); // Audit trail table var
...
@define("EW_USER_LEVEL_TABLE", "`t9902_userlevels`", TRUE);
...
@define("EW_USER_LEVEL_PRIV_TABLE", "`t9903_userlevelpermissions`", TRUE);
...
define("EW_USER_TABLE", "`t9901_employees`", TRUE);
