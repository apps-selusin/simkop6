...
$t0202_jaminan_add = NULL; // Initialize page object first

class ct0202_jaminan_add extends ct0202_jaminan {
	...
	// Page object name
	var $PageObjName = 't0202_jaminan_add';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "t0202_jaminanview.php")
...
// Create page object
if (!isset($t0202_jaminan_add)) $t0202_jaminan_add = new ct0202_jaminan_add();

// Page init
$t0202_jaminan_add->Page_Init();

// Page main
$t0202_jaminan_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t0202_jaminan_add->Page_Render();
?>
...
var CurrentForm = ft0202_jaminanadd = new ew_Form("ft0202_jaminanadd", "add");

// Validate form
ft0202_jaminanadd.Validate = function() {
...
ft0202_jaminanadd.Form_CustomValidate = 
...
ft0202_jaminanadd.ValidateRequired = true;
<?php } else { ?>
ft0202_jaminanadd.ValidateRequired = false; 
<?php } ?>
...
<?php if (!$t0202_jaminan_add->IsModal) { ?>
<div class="ewToolbar">
...
<?php } ?>
<?php $t0202_jaminan_add->ShowPageHeader(); ?>
<?php
$t0202_jaminan_add->ShowMessage();
?>
<form name="ft0202_jaminanadd" id="ft0202_jaminanadd" class="<?php echo $t0202_jaminan_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t0202_jaminan_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t0202_jaminan_add->Token ?>">
<?php } ?>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $t0202_jaminan_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
ft0202_jaminanadd.Init();
</script>
<?php
$t0202_jaminan_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$t0202_jaminan_add->Page_Terminate();
?>
