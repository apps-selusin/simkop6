...
$t9902_userlevels_add = NULL; // Initialize page object first

class ct9902_userlevels_add extends ct9902_userlevels {
	...
	// Page object name
	var $PageObjName = 't9902_userlevels_add';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "t9902_userlevelsview.php")
...
// Create page object
if (!isset($t9902_userlevels_add)) $t9902_userlevels_add = new ct9902_userlevels_add();

// Page init
$t9902_userlevels_add->Page_Init();

// Page main
$t9902_userlevels_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t9902_userlevels_add->Page_Render();
?>
...
var CurrentForm = ft9902_userlevelsadd = new ew_Form("ft9902_userlevelsadd", "add");

// Validate form
ft9902_userlevelsadd.Validate = function() {
...
ft9902_userlevelsadd.Form_CustomValidate = 
...
ft9902_userlevelsadd.ValidateRequired = true;
<?php } else { ?>
ft9902_userlevelsadd.ValidateRequired = false; 
<?php } ?>
...
<?php if (!$t9902_userlevels_add->IsModal) { ?>
<div class="ewToolbar">
...
<?php } ?>
<?php $t9902_userlevels_add->ShowPageHeader(); ?>
<?php
$t9902_userlevels_add->ShowMessage();
?>
<form name="ft9902_userlevelsadd" id="ft9902_userlevelsadd" class="<?php echo $t9902_userlevels_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t9902_userlevels_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t9902_userlevels_add->Token ?>">
<?php } ?>
...
<input type="text" data-table="t9902_userlevels" data-field="x_userlevelid" name="x_userlevelid" id="x_userlevelid" size="30" placeholder="<?php echo ew_HtmlEncode($t9902_userlevels->userlevelid->getPlaceHolder()) ?>" value="<?php echo $t9902_userlevels->userlevelid->EditValue ?>"<?php echo $t9902_userlevels->userlevelid->EditAttributes() ?>>
</span>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $t9902_userlevels_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
ft9902_userlevelsadd.Init();
</script>
<?php
$t9902_userlevels_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$t9902_userlevels_add->Page_Terminate();
?>
