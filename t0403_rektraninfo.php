...
//
// Table class for t0403_rektran
//
class ct0403_rektran extends cTable {
	...
	function __construct() {
		...
		$this->TableVar = 't0403_rektran';
		$this->TableName = 't0403_rektran';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`t0403_rektran`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('t0403_rektran', 't0403_rektran', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// KodeTransaksi
		$this->KodeTransaksi = new cField('t0403_rektran', 't0403_rektran', 'x_KodeTransaksi', 'KodeTransaksi', '`KodeTransaksi`', '`KodeTransaksi`', 200, -1, FALSE, '`KodeTransaksi`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->KodeTransaksi->Sortable = TRUE; // Allow sort
		$this->fields['KodeTransaksi'] = &$this->KodeTransaksi;

		// NamaTransaksi
		$this->NamaTransaksi = new cField('t0403_rektran', 't0403_rektran', 'x_NamaTransaksi', 'NamaTransaksi', '`NamaTransaksi`', '`NamaTransaksi`', 200, -1, FALSE, '`NamaTransaksi`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->NamaTransaksi->Sortable = TRUE; // Allow sort
		$this->fields['NamaTransaksi'] = &$this->NamaTransaksi;

		// KodeRekening
		$this->KodeRekening = new cField('t0403_rektran', 't0403_rektran', 'x_KodeRekening', 'KodeRekening', '`KodeRekening`', '`KodeRekening`', 200, -1, FALSE, '`KodeRekening`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`t0403_rektran`";
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("t0403_rektranview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("t0403_rektranview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "t0403_rektranadd.php?" . $this->UrlParm($parm);
		else
			$url = "t0403_rektranadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("t0403_rektranedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("t0403_rektranadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("t0403_rektrandelete.php", $this->UrlParm());
	}
   ...
   // Common render codes
	...
	function RenderEditRow() {
		...
		$this->KodeRekening->EditValue = $this->KodeRekening->CurrentValue;
