...
$t0302_angsuran_add = NULL; // Initialize page object first

class ct0302_angsuran_add extends ct0302_angsuran {
	...
	// Page object name
	var $PageObjName = 't0302_angsuran_add';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "t0302_angsuranview.php")
...
// Create page object
if (!isset($t0302_angsuran_add)) $t0302_angsuran_add = new ct0302_angsuran_add();

// Page init
$t0302_angsuran_add->Page_Init();

// Page main
$t0302_angsuran_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t0302_angsuran_add->Page_Render();
?>
...
var CurrentForm = ft0302_angsuranadd = new ew_Form("ft0302_angsuranadd", "add");

// Validate form
ft0302_angsuranadd.Validate = function() {
...
ft0302_angsuranadd.Form_CustomValidate = 
...
ft0302_angsuranadd.ValidateRequired = true;
<?php } else { ?>
ft0302_angsuranadd.ValidateRequired = false; 
<?php } ?>
...
<?php if (!$t0302_angsuran_add->IsModal) { ?>
<div class="ewToolbar">
...
<?php } ?>
<?php $t0302_angsuran_add->ShowPageHeader(); ?>
<?php
$t0302_angsuran_add->ShowMessage();
?>
<form name="ft0302_angsuranadd" id="ft0302_angsuranadd" class="<?php echo $t0302_angsuran_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t0302_angsuran_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t0302_angsuran_add->Token ?>">
<?php } ?>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $t0302_angsuran_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
ft0302_angsuranadd.Init();
</script>
<?php
$t0302_angsuran_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$t0302_angsuran_add->Page_Terminate();
?>
