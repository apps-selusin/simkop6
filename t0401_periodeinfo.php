...
//
// Table class for t0401_periode
//
class ct0401_periode extends cTable {
	...
	function __construct() {
		...
		$this->TableVar = 't0401_periode';
		$this->TableName = 't0401_periode';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`t0401_periode`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('t0401_periode', 't0401_periode', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// Bulan
		$this->Bulan = new cField('t0401_periode', 't0401_periode', 'x_Bulan', 'Bulan', '`Bulan`', '`Bulan`', 16, -1, FALSE, '`Bulan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Tahun
		$this->Tahun = new cField('t0401_periode', 't0401_periode', 'x_Tahun', 'Tahun', '`Tahun`', '`Tahun`', 2, -1, FALSE, '`Tahun`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Tahun_Bulan
		$this->Tahun_Bulan = new cField('t0401_periode', 't0401_periode', 'x_Tahun_Bulan', 'Tahun_Bulan', '`Tahun_Bulan`', '`Tahun_Bulan`', 200, -1, FALSE, '`Tahun_Bulan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`t0401_periode`";
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("t0401_periodeview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("t0401_periodeview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "t0401_periodeadd.php?" . $this->UrlParm($parm);
		else
			$url = "t0401_periodeadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("t0401_periodeedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("t0401_periodeadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("t0401_periodedelete.php", $this->UrlParm());
	}
