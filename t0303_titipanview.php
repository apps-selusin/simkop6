...
$t0303_titipan_view = NULL; // Initialize page object first

class ct0303_titipan_view extends ct0303_titipan {
	...
	// Page object name
	var $PageObjName = 't0303_titipan_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["id"] <> "") {
				...
				$sReturnUrl = "t0303_titipanlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "t0303_titipanlist.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "t0303_titipanlist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($t0303_titipan_view)) $t0303_titipan_view = new ct0303_titipan_view();

// Page init
$t0303_titipan_view->Page_Init();

// Page main
$t0303_titipan_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t0303_titipan_view->Page_Render();
?>
...
var CurrentForm = ft0303_titipanview = new ew_Form("ft0303_titipanview", "view");

// Form_CustomValidate event
ft0303_titipanview.Form_CustomValidate = 
...
ft0303_titipanview.ValidateRequired = true;
<?php } else { ?>
ft0303_titipanview.ValidateRequired = false; 
<?php } ?>
...
<div class="ewToolbar">
<?php if (!$t0303_titipan_view->IsModal) { ?>
<?php $Breadcrumb->Render(); ?>
<?php } ?>
<?php $t0303_titipan_view->ExportOptions->Render("body") ?>
<?php
	foreach ($t0303_titipan_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if (!$t0303_titipan_view->IsModal) { ?>
...
<?php $t0303_titipan_view->ShowPageHeader(); ?>
<?php
$t0303_titipan_view->ShowMessage();
?>
<form name="ft0303_titipanview" id="ft0303_titipanview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t0303_titipan_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t0303_titipan_view->Token ?>">
<?php } ?>
...
<?php if ($t0303_titipan->id->Visible) { // id ?>
	<tr id="r_id">
		<td><span id="elh_t0303_titipan_id"><?php echo $t0303_titipan->id->FldCaption() ?></span></td>
...
<?php echo $t0303_titipan->id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t0303_titipan->pinjaman_id->Visible) { // pinjaman_id ?>
	<tr id="r_pinjaman_id">
		<td><span id="elh_t0303_titipan_pinjaman_id"><?php echo $t0303_titipan->pinjaman_id->FldCaption() ?></span></td>
...
<?php echo $t0303_titipan->pinjaman_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t0303_titipan->Tanggal->Visible) { // Tanggal ?>
	<tr id="r_Tanggal">
		<td><span id="elh_t0303_titipan_Tanggal"><?php echo $t0303_titipan->Tanggal->FldCaption() ?></span></td>
...
<?php echo $t0303_titipan->Tanggal->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t0303_titipan->Keterangan->Visible) { // Keterangan ?>
	<tr id="r_Keterangan">
		<td><span id="elh_t0303_titipan_Keterangan"><?php echo $t0303_titipan->Keterangan->FldCaption() ?></span></td>
		<td data-name="Keterangan"<?php echo $t0303_titipan->Keterangan->CellAttributes() ?>>
<span id="el_t0303_titipan_Keterangan">
<span<?php echo $t0303_titipan->Keterangan->ViewAttributes() ?>>
<?php echo $t0303_titipan->Keterangan->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t0303_titipan->Masuk->Visible) { // Masuk ?>
	<tr id="r_Masuk">
		<td><span id="elh_t0303_titipan_Masuk"><?php echo $t0303_titipan->Masuk->FldCaption() ?></span></td>
...
<?php echo $t0303_titipan->Masuk->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t0303_titipan->Keluar->Visible) { // Keluar ?>
	<tr id="r_Keluar">
		<td><span id="elh_t0303_titipan_Keluar"><?php echo $t0303_titipan->Keluar->FldCaption() ?></span></td>
...
<?php echo $t0303_titipan->Keluar->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t0303_titipan->Sisa->Visible) { // Sisa ?>
	<tr id="r_Sisa">
		<td><span id="elh_t0303_titipan_Sisa"><?php echo $t0303_titipan->Sisa->FldCaption() ?></span></td>
...
<?php echo $t0303_titipan->Sisa->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t0303_titipan->Angsuran_Ke->Visible) { // Angsuran_Ke ?>
	<tr id="r_Angsuran_Ke">
		<td><span id="elh_t0303_titipan_Angsuran_Ke"><?php echo $t0303_titipan->Angsuran_Ke->FldCaption() ?></span></td>
...
<?php echo $t0303_titipan->Angsuran_Ke->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<script type="text/javascript">
ft0303_titipanview.Init();
</script>
<?php
$t0303_titipan_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$t0303_titipan_view->Page_Terminate();
?>
