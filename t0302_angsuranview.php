...
$t0302_angsuran_view = NULL; // Initialize page object first

class ct0302_angsuran_view extends ct0302_angsuran {
	...
	// Page object name
	var $PageObjName = 't0302_angsuran_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["id"] <> "") {
				...
				$sReturnUrl = "t0302_angsuranlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "t0302_angsuranlist.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "t0302_angsuranlist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($t0302_angsuran_view)) $t0302_angsuran_view = new ct0302_angsuran_view();

// Page init
$t0302_angsuran_view->Page_Init();

// Page main
$t0302_angsuran_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t0302_angsuran_view->Page_Render();
?>
...
var CurrentForm = ft0302_angsuranview = new ew_Form("ft0302_angsuranview", "view");

// Form_CustomValidate event
ft0302_angsuranview.Form_CustomValidate = 
...
ft0302_angsuranview.ValidateRequired = true;
<?php } else { ?>
ft0302_angsuranview.ValidateRequired = false; 
<?php } ?>
...
<div class="ewToolbar">
<?php if (!$t0302_angsuran_view->IsModal) { ?>
<?php $Breadcrumb->Render(); ?>
<?php } ?>
<?php $t0302_angsuran_view->ExportOptions->Render("body") ?>
<?php
	foreach ($t0302_angsuran_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if (!$t0302_angsuran_view->IsModal) { ?>
...
<?php $t0302_angsuran_view->ShowPageHeader(); ?>
<?php
$t0302_angsuran_view->ShowMessage();
?>
<form name="ft0302_angsuranview" id="ft0302_angsuranview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t0302_angsuran_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t0302_angsuran_view->Token ?>">
<?php } ?>
...
<?php if ($t0302_angsuran->id->Visible) { // id ?>
	<tr id="r_id">
		<td><span id="elh_t0302_angsuran_id"><?php echo $t0302_angsuran->id->FldCaption() ?></span></td>
...
<?php echo $t0302_angsuran->id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t0302_angsuran->pinjaman_id->Visible) { // pinjaman_id ?>
	<tr id="r_pinjaman_id">
		<td><span id="elh_t0302_angsuran_pinjaman_id"><?php echo $t0302_angsuran->pinjaman_id->FldCaption() ?></span></td>
...
<?php echo $t0302_angsuran->pinjaman_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t0302_angsuran->Angsuran_Ke->Visible) { // Angsuran_Ke ?>
	<tr id="r_Angsuran_Ke">
		<td><span id="elh_t0302_angsuran_Angsuran_Ke"><?php echo $t0302_angsuran->Angsuran_Ke->FldCaption() ?></span></td>
...
<?php echo $t0302_angsuran->Angsuran_Ke->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t0302_angsuran->Angsuran_Tanggal->Visible) { // Angsuran_Tanggal ?>
	<tr id="r_Angsuran_Tanggal">
		<td><span id="elh_t0302_angsuran_Angsuran_Tanggal"><?php echo $t0302_angsuran->Angsuran_Tanggal->FldCaption() ?></span></td>
...
<?php echo $t0302_angsuran->Angsuran_Tanggal->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t0302_angsuran->Angsuran_Pokok->Visible) { // Angsuran_Pokok ?>
	<tr id="r_Angsuran_Pokok">
		<td><span id="elh_t0302_angsuran_Angsuran_Pokok"><?php echo $t0302_angsuran->Angsuran_Pokok->FldCaption() ?></span></td>
...
<?php echo $t0302_angsuran->Angsuran_Pokok->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t0302_angsuran->Angsuran_Bunga->Visible) { // Angsuran_Bunga ?>
	<tr id="r_Angsuran_Bunga">
		<td><span id="elh_t0302_angsuran_Angsuran_Bunga"><?php echo $t0302_angsuran->Angsuran_Bunga->FldCaption() ?></span></td>
...
<?php echo $t0302_angsuran->Angsuran_Bunga->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t0302_angsuran->Angsuran_Total->Visible) { // Angsuran_Total ?>
	<tr id="r_Angsuran_Total">
		<td><span id="elh_t0302_angsuran_Angsuran_Total"><?php echo $t0302_angsuran->Angsuran_Total->FldCaption() ?></span></td>
...
<?php echo $t0302_angsuran->Angsuran_Total->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t0302_angsuran->Sisa_Hutang->Visible) { // Sisa_Hutang ?>
	<tr id="r_Sisa_Hutang">
		<td><span id="elh_t0302_angsuran_Sisa_Hutang"><?php echo $t0302_angsuran->Sisa_Hutang->FldCaption() ?></span></td>
...
<?php echo $t0302_angsuran->Sisa_Hutang->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t0302_angsuran->Tanggal_Bayar->Visible) { // Tanggal_Bayar ?>
	<tr id="r_Tanggal_Bayar">
		<td><span id="elh_t0302_angsuran_Tanggal_Bayar"><?php echo $t0302_angsuran->Tanggal_Bayar->FldCaption() ?></span></td>
...
<?php echo $t0302_angsuran->Tanggal_Bayar->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t0302_angsuran->Terlambat->Visible) { // Terlambat ?>
	<tr id="r_Terlambat">
		<td><span id="elh_t0302_angsuran_Terlambat"><?php echo $t0302_angsuran->Terlambat->FldCaption() ?></span></td>
...
<?php echo $t0302_angsuran->Terlambat->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t0302_angsuran->Total_Denda->Visible) { // Total_Denda ?>
	<tr id="r_Total_Denda">
		<td><span id="elh_t0302_angsuran_Total_Denda"><?php echo $t0302_angsuran->Total_Denda->FldCaption() ?></span></td>
...
<?php echo $t0302_angsuran->Total_Denda->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t0302_angsuran->Bayar_Titipan->Visible) { // Bayar_Titipan ?>
	<tr id="r_Bayar_Titipan">
		<td><span id="elh_t0302_angsuran_Bayar_Titipan"><?php echo $t0302_angsuran->Bayar_Titipan->FldCaption() ?></span></td>
...
<?php echo $t0302_angsuran->Bayar_Titipan->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t0302_angsuran->Bayar_Non_Titipan->Visible) { // Bayar_Non_Titipan ?>
	<tr id="r_Bayar_Non_Titipan">
		<td><span id="elh_t0302_angsuran_Bayar_Non_Titipan"><?php echo $t0302_angsuran->Bayar_Non_Titipan->FldCaption() ?></span></td>
...
<?php echo $t0302_angsuran->Bayar_Non_Titipan->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t0302_angsuran->Bayar_Total->Visible) { // Bayar_Total ?>
	<tr id="r_Bayar_Total">
		<td><span id="elh_t0302_angsuran_Bayar_Total"><?php echo $t0302_angsuran->Bayar_Total->FldCaption() ?></span></td>
...
<?php echo $t0302_angsuran->Bayar_Total->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t0302_angsuran->Keterangan->Visible) { // Keterangan ?>
	<tr id="r_Keterangan">
		<td><span id="elh_t0302_angsuran_Keterangan"><?php echo $t0302_angsuran->Keterangan->FldCaption() ?></span></td>
		<td data-name="Keterangan"<?php echo $t0302_angsuran->Keterangan->CellAttributes() ?>>
<span id="el_t0302_angsuran_Keterangan">
<span<?php echo $t0302_angsuran->Keterangan->ViewAttributes() ?>>
<?php echo $t0302_angsuran->Keterangan->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t0302_angsuran->Periode->Visible) { // Periode ?>
	<tr id="r_Periode">
		<td><span id="elh_t0302_angsuran_Periode"><?php echo $t0302_angsuran->Periode->FldCaption() ?></span></td>
...
<?php echo $t0302_angsuran->Periode->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<script type="text/javascript">
ft0302_angsuranview.Init();
</script>
<?php
$t0302_angsuran_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$t0302_angsuran_view->Page_Terminate();
?>
