...
$t0101_koperasi_edit = NULL; // Initialize page object first

class ct0101_koperasi_edit extends ct0101_koperasi {
	...
	// Page object name
	var $PageObjName = 't0101_koperasi_edit';
	...
	function Page_Main() {
		...
		if ($this->id->CurrentValue == "") {
			$this->Page_Terminate("t0101_koperasilist.php"); // Invalid key, return to list
		}
...
// Create page object
if (!isset($t0101_koperasi_edit)) $t0101_koperasi_edit = new ct0101_koperasi_edit();

// Page init
$t0101_koperasi_edit->Page_Init();

// Page main
$t0101_koperasi_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t0101_koperasi_edit->Page_Render();
?>
...
var CurrentForm = ft0101_koperasiedit = new ew_Form("ft0101_koperasiedit", "edit");

// Validate form
ft0101_koperasiedit.Validate = function() {
...
ft0101_koperasiedit.Form_CustomValidate = 
...
ft0101_koperasiedit.ValidateRequired = true;
<?php } else { ?>
ft0101_koperasiedit.ValidateRequired = false; 
<?php } ?>
...
<?php if (!$t0101_koperasi_edit->IsModal) { ?>
<div class="ewToolbar">
...
<?php } ?>
<?php $t0101_koperasi_edit->ShowPageHeader(); ?>
<?php
$t0101_koperasi_edit->ShowMessage();
?>
<form name="ft0101_koperasiedit" id="ft0101_koperasiedit" class="<?php echo $t0101_koperasi_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t0101_koperasi_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t0101_koperasi_edit->Token ?>">
<?php } ?>
...
<input type="hidden" data-table="t0101_koperasi" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($t0101_koperasi->id->CurrentValue) ?>">
<?php if (!$t0101_koperasi_edit->IsModal) { ?>
<div class="form-group">
	<div class="col-sm-offset-2 col-sm-10">
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $t0101_koperasi_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
ft0101_koperasiedit.Init();
</script>
<?php
$t0101_koperasi_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$t0101_koperasi_edit->Page_Terminate();
?>
