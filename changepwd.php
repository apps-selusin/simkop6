...
class cchangepwd extends ct9901_employees {
	...
	function __construct() {
		...
		if (!isset($GLOBALS["t9901_employees"])) $GLOBALS["t9901_employees"] = &$this;
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel($this->ProjectID . 't9901_employees');
		}
