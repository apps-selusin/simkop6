...
$t9902_userlevels = NULL;

//
// Table class for t9902_userlevels
//
class ct9902_userlevels extends cTable {
	...
	function __construct() {
		...
		$this->TableVar = 't9902_userlevels';
		$this->TableName = 't9902_userlevels';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`t9902_userlevels`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// userlevelid
		$this->userlevelid = new cField('t9902_userlevels', 't9902_userlevels', 'x_userlevelid', 'userlevelid', '`userlevelid`', '`userlevelid`', 3, -1, FALSE, '`userlevelid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// userlevelname
		$this->userlevelname = new cField('t9902_userlevels', 't9902_userlevels', 'x_userlevelname', 'userlevelname', '`userlevelname`', '`userlevelname`', 200, -1, FALSE, '`userlevelname`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`t9902_userlevels`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "t9902_userlevelslist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("t9902_userlevelsview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("t9902_userlevelsview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "t9902_userlevelsadd.php?" . $this->UrlParm($parm);
		else
			$url = "t9902_userlevelsadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("t9902_userlevelsedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("t9902_userlevelsadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("t9902_userlevelsdelete.php", $this->UrlParm());
	}
