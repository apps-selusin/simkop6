...
$t9902_userlevels_view = NULL; // Initialize page object first

class ct9902_userlevels_view extends ct9902_userlevels {
	...
	// Page object name
	var $PageObjName = 't9902_userlevels_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["userlevelid"] <> "") {
				...
				$sReturnUrl = "t9902_userlevelslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "t9902_userlevelslist.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "t9902_userlevelslist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($t9902_userlevels_view)) $t9902_userlevels_view = new ct9902_userlevels_view();

// Page init
$t9902_userlevels_view->Page_Init();

// Page main
$t9902_userlevels_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t9902_userlevels_view->Page_Render();
?>
...
var CurrentForm = ft9902_userlevelsview = new ew_Form("ft9902_userlevelsview", "view");

// Form_CustomValidate event
ft9902_userlevelsview.Form_CustomValidate = 
...
ft9902_userlevelsview.ValidateRequired = true;
<?php } else { ?>
ft9902_userlevelsview.ValidateRequired = false; 
<?php } ?>
...
<div class="ewToolbar">
<?php if (!$t9902_userlevels_view->IsModal) { ?>
<?php $Breadcrumb->Render(); ?>
<?php } ?>
<?php $t9902_userlevels_view->ExportOptions->Render("body") ?>
<?php
	foreach ($t9902_userlevels_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if (!$t9902_userlevels_view->IsModal) { ?>
...
<?php $t9902_userlevels_view->ShowPageHeader(); ?>
<?php
$t9902_userlevels_view->ShowMessage();
?>
<form name="ft9902_userlevelsview" id="ft9902_userlevelsview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t9902_userlevels_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t9902_userlevels_view->Token ?>">
<?php } ?>
...
<?php if ($t9902_userlevels->userlevelid->Visible) { // userlevelid ?>
	<tr id="r_userlevelid">
		<td><span id="elh_t9902_userlevels_userlevelid"><?php echo $t9902_userlevels->userlevelid->FldCaption() ?></span></td>
...
<?php echo $t9902_userlevels->userlevelid->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t9902_userlevels->userlevelname->Visible) { // userlevelname ?>
	<tr id="r_userlevelname">
		<td><span id="elh_t9902_userlevels_userlevelname"><?php echo $t9902_userlevels->userlevelname->FldCaption() ?></span></td>
...
<?php echo $t9902_userlevels->userlevelname->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<script type="text/javascript">
ft9902_userlevelsview.Init();
</script>
<?php
$t9902_userlevels_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$t9902_userlevels_view->Page_Terminate();
?>
