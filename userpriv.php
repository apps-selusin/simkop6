...
class cuserpriv extends ct9902_userlevels {
	...
	function __construct() {
		...
		if (!isset($GLOBALS["t9902_userlevels"])) $GLOBALS["t9902_userlevels"] = &$this;
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel(CurrentProjectID() . 't9902_userlevels');
	...
	function Page_Main() {
		...
		$Breadcrumb->Add("list", "t9902_userlevels", "t9902_userlevelslist.php", "", "t9902_userlevels");
...
<p><?php echo $Language->Phrase("UserLevel") ?><?php echo $Security->GetUserLevelName($t9902_userlevels->userlevelid->CurrentValue) ?>(<?php echo $t9902_userlevels->userlevelid->CurrentValue ?>)</p>
<?php
...
<input type="hidden" name="x_userlevelid" id="x_userlevelid" value="<?php echo $t9902_userlevels->userlevelid->CurrentValue ?>">
...
for ($i = 0; $i < $userpriv->TableNameCount; $i++) {
	$userpriv->TempPriv = $Security->GetUserLevelPrivEx($userpriv->TableList[$i][4] . $userpriv->TableList[$i][0], $t9902_userlevels->userlevelid->CurrentValue);
