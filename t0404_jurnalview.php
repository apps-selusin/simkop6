...
$t0404_jurnal_view = NULL; // Initialize page object first

class ct0404_jurnal_view extends ct0404_jurnal {
	...
	// Page object name
	var $PageObjName = 't0404_jurnal_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["id"] <> "") {
				...
				$sReturnUrl = "t0404_jurnallist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "t0404_jurnallist.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "t0404_jurnallist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($t0404_jurnal_view)) $t0404_jurnal_view = new ct0404_jurnal_view();

// Page init
$t0404_jurnal_view->Page_Init();

// Page main
$t0404_jurnal_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t0404_jurnal_view->Page_Render();
?>
...
var CurrentForm = ft0404_jurnalview = new ew_Form("ft0404_jurnalview", "view");

// Form_CustomValidate event
ft0404_jurnalview.Form_CustomValidate = 
...
ft0404_jurnalview.ValidateRequired = true;
<?php } else { ?>
ft0404_jurnalview.ValidateRequired = false; 
<?php } ?>
...
<div class="ewToolbar">
<?php if (!$t0404_jurnal_view->IsModal) { ?>
<?php $Breadcrumb->Render(); ?>
<?php } ?>
<?php $t0404_jurnal_view->ExportOptions->Render("body") ?>
<?php
	foreach ($t0404_jurnal_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if (!$t0404_jurnal_view->IsModal) { ?>
...
<?php $t0404_jurnal_view->ShowPageHeader(); ?>
<?php
$t0404_jurnal_view->ShowMessage();
?>
<form name="ft0404_jurnalview" id="ft0404_jurnalview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t0404_jurnal_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t0404_jurnal_view->Token ?>">
<?php } ?>
...
<?php if ($t0404_jurnal->id->Visible) { // id ?>
	<tr id="r_id">
		<td><span id="elh_t0404_jurnal_id"><?php echo $t0404_jurnal->id->FldCaption() ?></span></td>
...
<?php echo $t0404_jurnal->id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t0404_jurnal->Tanggal->Visible) { // Tanggal ?>
	<tr id="r_Tanggal">
		<td><span id="elh_t0404_jurnal_Tanggal"><?php echo $t0404_jurnal->Tanggal->FldCaption() ?></span></td>
...
<?php echo $t0404_jurnal->Tanggal->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t0404_jurnal->Periode->Visible) { // Periode ?>
	<tr id="r_Periode">
		<td><span id="elh_t0404_jurnal_Periode"><?php echo $t0404_jurnal->Periode->FldCaption() ?></span></td>
...
<?php echo $t0404_jurnal->Periode->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t0404_jurnal->NomorTransaksi->Visible) { // NomorTransaksi ?>
	<tr id="r_NomorTransaksi">
		<td><span id="elh_t0404_jurnal_NomorTransaksi"><?php echo $t0404_jurnal->NomorTransaksi->FldCaption() ?></span></td>
...
<?php echo $t0404_jurnal->NomorTransaksi->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t0404_jurnal->Rekening->Visible) { // Rekening ?>
	<tr id="r_Rekening">
		<td><span id="elh_t0404_jurnal_Rekening"><?php echo $t0404_jurnal->Rekening->FldCaption() ?></span></td>
...
<?php echo $t0404_jurnal->Rekening->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t0404_jurnal->Debet->Visible) { // Debet ?>
	<tr id="r_Debet">
		<td><span id="elh_t0404_jurnal_Debet"><?php echo $t0404_jurnal->Debet->FldCaption() ?></span></td>
...
<?php echo $t0404_jurnal->Debet->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t0404_jurnal->Kredit->Visible) { // Kredit ?>
	<tr id="r_Kredit">
		<td><span id="elh_t0404_jurnal_Kredit"><?php echo $t0404_jurnal->Kredit->FldCaption() ?></span></td>
...
<?php echo $t0404_jurnal->Kredit->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t0404_jurnal->Keterangan->Visible) { // Keterangan ?>
	<tr id="r_Keterangan">
		<td><span id="elh_t0404_jurnal_Keterangan"><?php echo $t0404_jurnal->Keterangan->FldCaption() ?></span></td>
...
<?php echo $t0404_jurnal->Keterangan->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<script type="text/javascript">
ft0404_jurnalview.Init();
</script>
<?php
$t0404_jurnal_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$t0404_jurnal_view->Page_Terminate();
?>
